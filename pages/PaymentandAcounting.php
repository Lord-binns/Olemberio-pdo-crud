...
if (isset($_GET['payment_id']) && is_numeric($_GET['payment_id'])) {
    ...
    if ($payment_id > 0) {
        echo "Debug: payment_id received is $payment_id<br>"; // Debugging statement
        ...
        echo "Invalid payment_id. It shyawaould be greater than 0.";
        exit();
    }
} else {
    echo "Invalid request. Payment ID is missing or invalid.";
    exit();
}
?>
