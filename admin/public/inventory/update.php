...
if ($stmt = $pdo->prepare($sql)) {
    ...
    // Set parameters
    $param_products_id = trim($_GET["products_id"]);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($title_err) && empty($description_err) && empty($price_err) && empty($rrp_err) && empty($quantity_err) && empty($img_err)) {
        ...
        $sql = "UPDATE products SET title = :title, description = :description, price = :price, rrp = :rrp, quantity = :quantity, img = :img WHERE products_id = :products_id";
        ...
        if ($stmt = $pdo->prepare($sql)) {
            ...
            // Set the product ID
            $param_products_id = $_POST["products_id"]; // Assuming you have a hidden input field named "products_id" in your form
